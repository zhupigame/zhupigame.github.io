...
<br><br><span style="color:#3B82F6;font-weight:bold">1、沉浸式潜行体验</span>
<br>置身于逼真的住宅区、购物中心等环境中，你将执行高风险任务，感受第一人称视角下的紧张刺激。动态天气与昼夜循环为每个角落增添了未知与变数，暴雨夜的阴影将成为你的最佳掩护，而正午的强光则可能暴露你的行踪。玩家实测反馈：“在天桥执行任务时，一个路人的发现带来的3D视野压迫感，简直像是在玩恐怖游戏！
<br><br><span style="color:#3B82F6;font-weight:bold">2、暴露与伪装的艺术</span>
<br>拥有超过50套可自定义服装与彩绘系统，你可以自由切换“隐形人”与“诱惑者”的双重身份。在商务场合中，你可能是西装革履的绅士，下一秒却可能露出彩绘纹身挑衅NPC。而内衣外穿的冒险者，则能通过精准走位在人群中巧妙脱身。创意玩法如“外套呼脸”“手铐束缚”等，将潜行游戏转变为一场充满黑色幽默的行为艺术盛宴。
<br><br><span style="color:#3B82F6;font-weight:bold">3、策略性任务设计</span> 
<br>从“货车车头点位”的道具操作到无人机任务的极限挑战，每个任务都要求你因地制宜地制定战术。玩家分享：“我曾尝试用彩绘伪装成清洁工在购物中心执行任务，结果被巡逻AI识破，紧急躲进试衣间换装的那一刻，肾上腺素飙升的感觉简直比吃鸡决赛圈还要刺激！”
<br><br><span style="color:#3B82F6;font-weight:bold">4、玩家体验</span>
<br>值得一提的是，其针对低配置设备的优化使得中端机器也能轻松运行，从而让更多玩家能够享受到潜行的乐趣。在《塞雷卡 2》的开放世界中，道德与欲望的冲突无处不在，暴露与隐蔽的生存法则被演绎得淋漓尽致。这款游戏以极致的潜行体验，诠释了真正的冒险并非简单的硬碰硬对决，而是智慧与胆量的绝妙配合。`,},
...
<br><br><span style="color:#3B82F6;font-weight:bold">1、核心内容</span>
<br>1.自由探索：有6张以上不同风格的地图（图书馆、泳池、超市等），支持360度无死角视角切换，玩家能自由控制角色在城市里移动。
<br>2.任务系统：通过主线剧情和支线任务（比如"手铐任务"）拿经验值，解锁新内容。要注意避开NPC视线，不然可能触发游戏漏洞或者任务失败。
<br>3.服装互动：有66套以上能换的服装（内衣、泳衣、配饰等），部分服装有动态效果（比如泳衣遇水溶解）。
<br><br><span style="color:#3B82F6;font-weight:bold">2、暴露与伪装的艺术</span>              
<br>主角罗克珊表面腼腆害羞，心里却想通过"暴露行为"得到自由感。玩家要帮她在城市里实现这个隐秘欲望，同时应对NPC的监视和各种潜在风险。
<br><br><span style="color:#3B82F6;font-weight:bold">3、游戏特色</span>
<br>1.高自由度设计：除了主线，玩家能自己选探索区域、服装搭配和互动方式，还能用环境隐藏（比如躲进垃圾箱或长椅下面）。
<br>2.智能NPC系统：NPC行为优化过，视野只在前面区域，不会僵着看玩家；部分NPC会随机逃跑或者触发特殊事件（比如泳池出现警车）。				
<br>3.细节优化：新增绳索去除功能（身体标记）、饮料补充能量、隐藏状态特殊互动等，让游戏更真实。
<br>4.动态场景：支持360度旋转视角，能全方位看角色动作和环境细节，特别是淋浴区等特殊场景。`,},
...
<br><br><span style="color:#3B82F6;font-weight:bold">1、抽象与正剧并存</span>
<br>游戏的剧情风格奇特，在荒诞的情节中突然插入正剧元素，如舍友因家庭情况和主角影响走上歧途等，形成强烈的反差感，让玩家在游戏过程中不断感受到惊喜和意外。
<br><br><span style="color:#3B82F6;font-weight:bold">2、丰富的小彩蛋</span>
<br>在游戏的各个角落都隐藏着作者设置的小彩蛋，如爸爸的奇怪要求、厕所隔间的提示等，增加了游戏的趣味性和探索性。
<br><br><span style="color:#3B82F6;font-weight:bold">3、内置小游戏</span>
<br>玩家在游戏内的手机中可以玩到3D跳跃解密游戏和第一人称恐怖游戏等，丰富了游戏的内容和玩法。
<br><br><span style="color:#3B82F6;font-weight:bold">4、隐藏剧情</span> 
<br>还有各种支线任务和隐藏任务，玩家需要通过与不同的角色互动、探索校园的各个角落来触发和完成任务。`,},
...
description: `"爬行实验室"，是新纶工业在深山中建造的秘密设施。在这里，正在研究使用新开发的人工生命体"生物娃娃"的新产品。然而有一天，网络爬行人工智能窃取了第二代'生物娃娃'的身体，自称为“爬行女王”，并控制了实验室的所有设施。主角奉命前往实验室取回研究资料，却因一场意外事故，被独自留在实验室……他能否逃出爬行女王控制的实验室？
<br>获取弹药并升级你的枪来击败爬行女王的爪牙。逃离实验室。!
<br><br><span style="color:#3B82F6;font-weight:bold">1、核心内容</span>
<br>1.自由探索：有6张以上不同风格的地图（图书馆、泳池、超市等），支持360度无死角视角切换，玩家能自由控制角色在城市里移动。
<br>2.任务系统：通过主线剧情和支线任务（比如"手铐任务"）拿经验值，解锁新内容。要注意避开NPC视线，不然可能触发游戏漏洞或者任务失败。
<br>3.服装互动：有66套以上能换的服装（内衣、泳衣、配饰等），部分服装有动态效果（比如泳衣遇水溶解）。
...
<br><br><span style="color:#3B82F6;font-weight:bold">1、角色设定</span>
<br>伊妮莎是游戏的主角，她拥有修长的美腿和美丽的外貌，身着引人注目的高叉泳衣般的修女服，搭配白丝（可换黑丝）裤袜和高跟鞋。在战斗中，她手持长枪（或伞枪）与怪物激烈对抗。
<br><br><span style="color:#3B82F6;font-weight:bold">2、特殊机制</span>
<br>魔镜：靠近会被禁锢，需冲刺挣脱。
<br>铁处女：献祭生命可解锁掉落物品（金币、钥匙、道具），但有几率被强制吞入。
<br>血藤蔓：需用火系或毒系伤害打破。
<br>肉通道：内含双胞胎BUFF，可获取特殊能力。`,},
...
<br><br><span style="color:#3B82F6;font-weight:bold">1、游戏特色</span>
<br>1、精美画面和流畅动画：游戏拥有逼真的3D画面和流畅的动画效果，让玩家仿佛置身于游戏世界之中。
<br>2、多样化的角色互动：玩家可以与多位魔女角色进行互动，解锁不同的剧情和CG，为游戏增添更多乐趣。
<br>3、回合制战斗系统：游戏采用回合制战斗，玩家需要在回合中指挥角色进行攻击、防御等操作，战斗策略至关重要。
<br><br><span style="color:#3B82F6;font-weight:bold">2、游戏亮点</span>
<br>1、战斗系统策略性高：玩家需要根据不同敌人的特点，合理运用角色技能和装备，制定战术，才能取得胜利。
<br>2、剧情丰富多变：游戏设置了丰富的剧情线索和角色互动，通过与魔女互动解锁不同的剧情，让玩家沉浸于游戏世界中。
<br>3、全3D动态场景：游戏将玩家带入全3D动态场景中，细致精美的画面设计让游戏更加生动逼真。
<br>4、丰富的角色和道具：游戏中设有多种角色和道具可供玩家选择和使用，增加游戏可玩性。`,},
...
<br><br><span style="color:#3B82F6;font-weight:bold">1、游戏特色</span>
<br>游戏采用了非常细腻和迷人的像素画风，角色动作流畅，场景细节丰富，配合出色的光影效果和音乐，成功营造了一个既美丽又神秘的奇幻世界氛围。`,},
...
<br>跟踪美少女在没人的地方互动。互动时注意路人和警察。剩下更多玩法自行探索吧。`,},
...
{id: 76, name: "援助学院",type: [2,3], isFeatured: false,size: "3.9GB+",version: "3.1",updateDate: "2025-12-11",
description: `游戏的故事讲述了主角为了帮助一个小镇恢复繁荣，被强制转学到一个名为“私立援助怀孕学园”的学校，他必须帮助全校的女生完成全体怀孕的任务，或者想办法逃离学园。游戏的特色包括：全3D动态表现，超过40种以上的奇妙动画场景，自由选择让女生怀孕。各种H小道具和H属性系统，超自由开放3D校园世界，目标是让100人怀孕！游戏支持中文汉化，并有CV配音。`,},
{id: 77, name: "我可爱的表组",type: [2,3], isFeatured: false,size: "7GB+",version: "3.1",updateDate: "2025-12-12",
description: `一款可爱的角色扮演游戏，玩家将扮演一位刚刚毕业的大学生，回到家乡后发现自己的表姐已经成长为一位美丽性感的女性。`,},
{id: 78, name: "修女地下城",type: [2], isFeatured: false,size: "600MB+",version: "",updateDate: "2025-12-13",
description: `一款动感十足的 roguelike 游戏，您可以扮演身经百战的修女，探索地牢并追捕吸血鬼。每次杀死吸血鬼时，你都可以吸收他们的力量来变得更强大，或者卖掉它来升级你的装备。你会接受吸血鬼的黑暗力量，还是仅仅依靠人类的力量？选择权在你手中。`,},
{id: 79, name: "稻荷",type: [2], isFeatured: false,size: "2GB+",version: "1.5.7",updateDate: "2025-12-15",
description: `你在旧仓库翻出一张神秘藏宝图，顺着线索回到久违的故乡，寄宿在阿姨家开启悠闲生活。作为养成互动类游戏，玩法自由到离谱——既能和高岭、朝美、澪三位女主约会刷好感，又能钓鱼、采集、打工搞钱，做家务还能解锁隐藏剧情，支线迷你游戏根本玩不重样。`,},
{id: 80, name: "哥特少女勇闯恶魔城",type: [2], isFeatured: false,size: "2GB+",version: "1.1.0",updateDate: "2025-12-16",
description: `被全球ACT玩家奉为神作的像素冒险闯关游戏，英文名叫SiNiSistar Lite Version，以恶魔城为背景，玩家将扮演哥特服饰风格的修女去进行闯关，在这座危机四伏的恶魔城里战斗，寻找线索完成任务。游戏将恶魔城的城寨探索与黑魂的受击硬直机制熔铸成独特战斗系统。当你操控修女装束的赛琳娜时，每次挥动链锤都需要计算0.7秒的武器惯性——这个数值恰好是恶魔翼龙俯冲攻击的前摇时长。`,},
{id: 81, name: "女忍者训练师",type: [1], isFeatured: false,size: "500MB+",version: "1.1.0",updateDate: "2025-12-18",
description: `一款拥有优质的火影背景设定，提供了优质的二次元风格画面表现，提供了简单玩法设计，可以在手机上自由感受过高品质趣味互动的手游。游戏提供了简单操作方法，搭配轻松的玩法设计，通过自由选项选择即刻见证丰富优质剧情展开。`,},
{id: 82, name: "转生成为马桶",type: [2], isFeatured: false,size: "700MB+",version: "1.0",updateDate: "2025-12-19",
description: `当阳光透过浴室磨砂玻璃照在我雪白的陶瓷身躯上时，我才意识到自己真的变成了马桶。你将要和女主一起生活，见证女主不为人知的一面`,},
{id: 83, name: "薇薇与魔法岛",type: [2], isFeatured: false,size: "700MB+",version: "1.0.5",updateDate: "2025-12-20",
description: `一款有着细腻画风的二次元美少女冒险游戏。玩家将扮演一名美少女护卫薇薇为了保护自己的主人而在小岛上进行冒险探索，并在途中不断的击败敌人。游戏有着十分出色细腻的游戏画风的同时，出色的动作系统以及qte玩法也是十分的有趣。同时游戏中还有着丰富的剧情cg以及不同的结局等着玩家来解锁。`,},
{id: 84, name: "医院诱惑",type: [2], isFeatured: false,size: "700MB+",version: "1.0.5",updateDate: "2025-12-21",
description: `游戏中男主因过度用功，身心都疲惫到了极点，为了好好休养，他住进了医院。可这医院绝非寻常之地。本应宁静祥和的住院生活，很快就被卷入了现实与噩梦相互交织的诡异漩涡。随着一个个夜晚悄然流逝，男子心中的疑虑也如野草般不断滋长。`,},
{id: 85, name: "逃离办公室",type: [2], isFeatured: false,size: "7GB+",version: "1.0.5",updateDate: "2025-12-22",
description: `游戏中该游戏的背景设定为一名女性角色在非工作日上班时遭遇小偷，被捆绑后需要设法逃脱和解救。‌游戏强调解谜和逃脱元素，玩家需在紧张情境中寻找线索和工具以突破困境。‌`,},
{id: 86, name: "病娇模拟器",type: [1,2], isFeatured: false,size: "500MB+",version: "",updateDate: "2025-12-22",
description: `游戏设定在日本的一所名为“赤魅学院”（早期设定为高中）的高校内，玩家扮演的主角病娇酱（Yandere-chan）病态般的喜欢上了学长，玩家需要操纵主角，通过和平或极端的手段来铲除所有情敌，以保护自己的“爱情”。‌`,},
{id: 87, name: "隐秘的遗产",type: [2,3], isFeatured: false,size: "400MB+",version: "",updateDate: "2025-12-24",
description: `玩家扮演主角，调查家族隐秘遗产与诅咒，在阴森庄园、古宅、废墟等场景中，通过找线索、读日记、破密码，逐步揭开血脉与过往的黑暗秘密。‌`,},
{id: 88, name: "台湾恋爱物语",type: [2,3], isFeatured: false,size: "2GB+",version: "",updateDate: "2025-12-25",
description: `本作可攻略角色为五，分别为热炒店老板娘王秋霞，槟榔西施小咘，上班族林姿婷，千金小姐张书嫚，以及潜水员海稣儿。剧情方面，本作讲述了主人公以一个吻为契机，与五个女孩子……（中的一个）的恋爱故事。在这个游戏系统中，你需要赚钱，提升自我，以此获得心上人的芳心。‌`,},
{id: 89, name: "路人娘电车",type: [2,3], isFeatured: false,size: "300MB+",version: "",updateDate: "2025-12-26",
description: `一款免费像素风格模拟游戏，在这款游戏中，玩家需要维护电车内的秩序。玩家需要检查车票，调查有无违反礼仪的行为，并对各种各样的地方进行触摸检查。游戏以规则为名，进行触摸，顺便也做些H的事吧！这款游戏考验玩家的观察力和判断力，适合喜欢角色扮演和剧情选择的玩家。‌`,},
{id: 90, name: "我和朋友陪妈妈去露营",type: [2,3], isFeatured: false,size: "300MB+",version: "",updateDate: "2025-12-230",
description: `一款集休闲、探险与亲子互动于一体的模拟露营游戏。游戏以温馨的家庭露营为背景，玩家将扮演孩子角色，与妈妈和朋友们一同踏上精彩的露营之旅。通过丰富的游戏内容和有趣的挑战任务，让玩家在游戏中体验露营的乐趣，增进家庭成员和朋友间的感情。‌`,},
{id: -1, name: "我与夏日里的姐姐们",type: [2,3], isFeatured: false,size: "300MB+",version: "",updateDate: "2025-12-26",
description: `在这款游戏中，你将化身为一位返乡度假的少年，开启一段与四位截然不同性格姐姐的夏日邂逅。这四位姐姐分别是温柔体贴的邻家姐姐，充满活力的职场女性，知性优雅的教师，以及娇俏可人的学妹。你们从最初的日常相伴，逐渐深入到彼此的心灵深处，共同解锁这个夏日里独有的治愈力量与甜蜜回忆。‌`,},
{id: -1, name: "夏穗，我陷入恋爱的30天",type: [2,3], isFeatured: false,size: "300MB+",version: "",updateDate: "2025-12-26",
description: `回到乡下，重逢许久未见的夏姐，她已完全褪去青涩，变得成熟大方…“凑君，就让我来先一步把你变成大人吧。”耳边响起的，是那时同样温柔的声音。但内容却截然不同。‌`,},
{id: -1, name: "通勤电车少女",type: [2,3], isFeatured: false,size: "300MB+",version: "",updateDate: "2025-12-26",
description: `一款日式策略角色扮演游戏，这款游戏巧妙地以日常的电车旅程为背景，围绕发生在车厢内的那些不期而遇的邂逅，缓缓展开一段段动人的故事。‌`,},
{id: -1, name: "她在末日中堕落了",type: [2,3], isFeatured: false,size: "300MB+",version: "",updateDate: "2025-12-26",
description: `置身于末日的世界，看着身边的女友逐渐走向堕落，这是一种怎样的体验？是无奈的接受，还是拼尽全力去挽回？在这个充满未知与挑战的时刻，你将如何抉择，又能否守护住那份珍贵的爱情？‌`,},
{id: -1, name: "兔女的奇妙异星冒险",type: [2,3], isFeatured: false,size: "300MB+",version: "",updateDate: "2025-12-26",
description: `一款设计独特的横版动作游戏。游戏中，主角艾莉的体力至关重要，是维系其生存的根本。当遭到攻击时，她的体力将如沙漏中的沙粒不断消逝，直至耗尽昏迷。如果在昏迷时不幸被暗处怪物擒获，那么等待她的很可能将是最为糟糕的可怕后果。‌`,},
{id: -1, name: "骰子少女",type: [2,3], isFeatured: false,size: "300MB+",version: "",updateDate: "2025-12-26",
description: `与其他投掷骰子的游戏相比，比较新颖独特，此版本提供透视功能，玩家在这里需要想尽一切办法让自己的点数比对方大，在对决中赢得最终胜利，惩罚对方，技巧和运气都是必不可少的，游戏氛围无比欢乐。‌`,},
{id: -1, name: "天堂女仆",type: [2,3], isFeatured: false,size: "300MB+",version: "",updateDate: "2025-12-26",
description: `拯救遭受闭店危机的女仆咖啡店的小女仆们吧。培养她们，让她们成为可爱的一流的女仆。‌`,},
{id: -1, name: "GTA5",type: [2], isFeatured: false,size: "10GB+",version: "",updateDate: "2025-12-29",
